...
void Screen_InitializeUI(void)
{
	...
	uibutton[BUTTON_ID_SORT_BY_TYPE].y1_ = UI_MIDDLE_AREA_DEV_CMD_Y + 4;
	...
	uibutton[BUTTON_ID_SORT_BY_NAME].y1_ = UI_MIDDLE_AREA_DEV_CMD_Y + 5;
	...
	uibutton[BUTTON_ID_SORT_BY_SIZE].y1_ = UI_MIDDLE_AREA_DEV_CMD_Y + 6;
